...
<option value="poppost" <?php selected( $clickaction, 'poppost' ); ?>><?php echo __('Popup post overlay', 'onepiece'); ?></option>
<option value="popcat" <?php selected( $clickaction, 'popcat' ); ?>><?php echo __('Popup category overlay', 'onepiece'); ?></option>
</select>
</p>
<?php 
}
