...
<li class="tab2 tab"><h3>Register</h3><p>Sign up with email(or social account)</p>
...
<?php } else { // is logged in 
			...
			echo '<div class="infocontainer"><h3>Welcome, '. $user_identity .'</h3>';
			...
			echo '<div class="loggedtext">'. __('You&rsquo;re logged in as', 'onepiece') .' <strong>'. $user_identity .'</strong></div>';
